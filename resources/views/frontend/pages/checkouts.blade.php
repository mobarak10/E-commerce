	    ...
	    <form method="POST" action="{{ route('checkouts.store') }}">
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="message" rows="4" type="text" class="form-control @error('message (*)') is-invalid @enderror" name="message" autocomplete="message"></textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="shipping_address" rows="4" type="text" class="form-control @error('shipping_address (*)') is-invalid @enderror" name="shipping_address" autocomplete="shipping_address">{{ Auth::check() ? Auth::user()->shipping_address : '' }}</textarea>
					...
					@foreach ($payments as $payment)
						...
						@else
							<div id="payment_{{ $payment->short_name }}" class="alert alert-success mt-2 text-center hidden">
								...
								<p>
									<strong>{{ $payment->name }} Number :  {{ $payment->number }}</strong>
									<br>
									<strong>Account Type: {{ $payment->type }}</strong>
								</p>
								<div class="alert alert-success">
									Please send the above money to this {{ $payment->name }} Number and write your transaction code below there..
								</div>
