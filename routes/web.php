...
/*
Product Route
All the Route for our product frontend
*/
Route::group(['prefix' => 'products'], function() {
	...
	//categories Route
	Route::get('/search/', 'Frontend\CategoriesController@index')->name('categories.index');
	Route::get('/search/{id}', 'Frontend\CategoriesController@show')->name('categories.show');
...
Route::group(['prefix' => 'user'], function() {
	...
	//user route
	Route::get('/token/{token}', 'Frontend\VarificationsController@verify')->name('user.varification');
...
// Route::get('/admin/create', 'AdminPagesController@create')->name('admin.product.create'); 
